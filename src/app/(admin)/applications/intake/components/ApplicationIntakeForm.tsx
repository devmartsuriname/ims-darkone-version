...
const propertySchema = z.object({
  ...
  property_district: z.string().min(1, 'Property district is required'),
  property_type: z.string().min(1, 'Property type is required'),
  property_surface_area: z.number().min(1, 'Surface area must be positive'),
  title_type: z.string().min(1, 'Title type is required'),
  ownership_status: z.string().min(1, 'Ownership status is required'),
